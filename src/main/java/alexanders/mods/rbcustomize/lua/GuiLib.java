...
public class GuiLib extends TwoArgFunction {
    ...
    private Varargs createText(Varargs varargs) {
    ...
    private static class LuaGui extends Gui {
        ...
        public void render(IGameInstance game, IAssetManager manager, IRenderer g) {
            if (data.render != null) {
                ...
                LuaEnvironment.executeScript(data.render, userdataOf(this));
            } else {
        ...
        public void renderOverlay(IGameInstance game, IAssetManager manager, IRenderer g) {
            if (data.renderOverlay != null) {
                AssetManagerLib.manager = manager;
                RendererLib.renderer = g;
                LuaEnvironment.executeScript(data.renderOverlay, userdataOf(this));
            } else {
    ...
    private static class LuaGuiData {
