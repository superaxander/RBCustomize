...
public class TilesLib extends TwoArgFunction {
    ...
    private Varargs addTile(Varargs varargs) { // name, description, init
        ...
        new LuaTile(name, description, canBreak, canPlace, canStay, canReplace, onRemoved, onAdded, onDestroyed, onInteractWith, onChangeAround, onScheduledUpdate,
                    onCollideWithEntity, updateRandomly, bb, bbs, placeableLayers, drops, hasItem, canClimb, canGrassSpreadTo, canKeepPlants, canLiquidSpreadInto, isFullTile,
                    hardness, interactionPriority).register();
    ...
    private static class LuaTile extends TileBasic {
        ...
        private LuaTile(IResourceName name, String[] description, LuaValue canBreak, LuaValue canPlace, LuaValue canStay, LuaValue canReplace, LuaValue onRemoved, LuaValue onAdded, LuaValue onDestroyed, LuaValue onInteractWith, LuaValue onChangeAround, LuaValue onScheduledUpdate, LuaValue onCollideWithEntity, LuaValue updateRandomly, BoundBox bb, List<BoundBox> bbs, List<TileLayer> placeableLayers, List<ItemInstance> drops, boolean hasItem, boolean canClimb, boolean canGrassSpreadTo, boolean canKeepPlants, boolean canLiquidSpreadInto, boolean isFullTile, float hardness, int interactionPriority) {
            super(name);
